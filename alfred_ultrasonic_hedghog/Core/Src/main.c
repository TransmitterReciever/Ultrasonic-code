...
void TIM1_CC_IRQHandler(void)
{
    ...
    if (listen_active && ++listen_count >= LISTEN_CYCLES)
    {
        tof_armed     = 0;
        listen_active = 0;
    }
